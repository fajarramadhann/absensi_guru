            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $item->jabatan }}</td>
                  <td>
                    <a href="{{ route('data-tata-usaha.edit', $item->id) }}" class="btn btn-warning"><i class="far fa-edit"></i> Edit</a>
                    <form action="{{ route('data-tata-usaha.destroy', $item->id) }}" method="POST" class="d-inline">
                      @csrf
                      @method('DELETE')
